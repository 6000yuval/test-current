        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <div className="flex justify-center gap-4">
            <a 
              ...
              className="bg-indigo-500 hover:bg-indigo-600 text-white px-8 py-3 rounded-full font-bold transition-all shadow-lg hover:shadow-indigo-500/30 cursor-pointer"
            >
              התחילו לקרוא
            </a>
