  ...
  return (
    <Link href={`/article/${article.id}`} className="group flex flex-col bg-white rounded-xl overflow-hidden border border-slate-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-4 flex items-center text-sm font-bold text-indigo-600 opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0 duration-300">
          קרא עוד ←
        </div>
      </div>
    </Link>
