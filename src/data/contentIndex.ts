...
// In a real app, these imports would come from 'generated/posts/...'
// We are mapping the existing Blogs/ files to this data layer.
...
export const CATEGORIES: Category[] = [
  ...
  { id: 'skills', title: 'מיומנות (הנדסת פרומפט)', description: 'כיצד לנסח קלט (Prompt) בצורה שתמקסם את איכות הפלט.', color: 'bg-yellow-100 text-yellow-800', icon: React.createElement(Zap, { className: "w-5 h-5" }) },
  { id: 'thinking', title: 'עיבוד וניתוח', description: 'שימוש במערכת לצורך פירוק בעיות, סיעור מוחות וניתוח לוגי.', color: 'bg-orange-100 text-orange-800', icon: React.createElement(Brain, { className: "w-5 h-5" }) },
  { id: 'reliability', title: 'בדיקה ואמינות', description: 'זיהוי מידע שגוי, אימות עובדות והצלבת מקורות.', color: 'bg-blue-100 text-blue-800', icon: React.createElement(CheckCircle, { className: "w-5 h-5" }) },
  { id: 'personal', title: 'שימוש אישי', description: 'יישומים יומיומיים: ניסוח טקסטים, ארגון מידע ולימוד.', color: 'bg-purple-100 text-purple-800', icon: React.createElement(Home, { className: "w-5 h-5" }) },
  { id: 'work', title: 'עבודה ולימודים', description: 'כתיבה עסקית, סיכום מסמכים וניתוח נתונים.', color: 'bg-amber-100 text-amber-800', icon: React.createElement(Briefcase, { className: "w-5 h-5" }) },
  { id: 'automation', title: 'מערכות ואוטומציה', description: 'שילוב מודלי שפה בתהליכים אוטומטיים.', color: 'bg-red-100 text-red-800', icon: React.createElement(Layers, { className: "w-5 h-5" }) },
  { id: 'safety', title: 'בטיחות ופרטיות', description: 'שמירה על מידע אישי ומגבלות השימוש.', color: 'bg-emerald-100 text-emerald-800', icon: React.createElement(Shield, { className: "w-5 h-5" }) },
  { id: 'master', title: 'מדריכי עומק', description: 'סקירות מקיפות על מתודולוגיות עבודה מתקדמות.', color: 'bg-indigo-100 text-indigo-800', icon: React.createElement(Star, { className: "w-5 h-5" }) },
];
